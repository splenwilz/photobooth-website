    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 pt-4">
      ...
      <nav 
        className={`
          ...
          ${scrolled 
            ? "bg-[#0a0a0a]/95 backdrop-blur-xl border-zinc-800 shadow-lg shadow-black/20" 
            : "bg-[#0a0a0a]/60 backdrop-blur-md border-zinc-800/50"
          }
        `}
      >
        <div className="px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="relative">
              ...
              {/* Pulse dot */}
              <div className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-[#10B981] border-2 border-[#0a0a0a]">
                <div className="absolute inset-0 rounded-full bg-[#10B981] animate-ping opacity-50" />
              </div>
            </div>
            {/* Logo text */}
            <div className="hidden sm:block">
              <span className="font-bold text-white tracking-tight">PhotoBooth</span>
              <span className="font-bold text-[#0891B2] tracking-tight">X</span>
            </div>
          </Link>

          {/* Desktop Links - Pill container */}
          <div className="hidden md:flex items-center p-1 rounded-full bg-zinc-900/50 border border-zinc-800/50">
            {links.map((link) => {
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/signin"
              className="hidden md:flex items-center gap-2 px-4 py-2 text-sm text-zinc-400 hover:text-white transition-colors rounded-lg hover:bg-zinc-800/50"
            >
            ...
            <button
              ...
              className="md:hidden p-2 text-zinc-400 hover:text-white rounded-lg hover:bg-zinc-800/50 transition-colors"
          ...
          <div className="px-4 pb-4 pt-2 border-t border-zinc-800/50">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link
                href="/signin"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-zinc-300 bg-zinc-800/50 rounded-xl hover:bg-zinc-800 transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
