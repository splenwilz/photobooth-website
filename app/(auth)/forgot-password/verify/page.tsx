...
function VerifyResetCodeFormWrapper() {
  return (
    <Suspense fallback={
      <div className="flex items-center justify-center py-12">
        <svg className="w-8 h-8 animate-spin text-[#0891B2]" fill="none" viewBox="0 0 24 24">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            <h2 className="text-4xl font-bold mb-4 leading-tight text-zinc-900 dark:text-white">
              Check your email.<br />
              <span className="text-[#0891B2]">Enter the code.</span>
            </h2>
            <p className="text-zinc-600 dark:text-zinc-400 text-lg mb-8 max-w-md">
              We sent a 6-digit code to your email. Enter it below to verify your identity and reset your password.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-zinc-600 dark:text-zinc-500">Code expires in 15 minutes</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
