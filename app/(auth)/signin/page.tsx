      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-8">
            <button className="group w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-black font-medium hover:bg-zinc-100 transition-all">
