      ...
      <section className="relative pt-16 pb-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            We&apos;d love to<br />
            <span className="text-[#069494]">hear from you</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            {contactOptions.map((option) => (
              <div
                key={option.title}
                className="p-6 rounded-2xl bg-[var(--card)] border border-[var(--border)] hover:border-[#069494]/30 transition-colors"
              >
                ...
                <a
                  ...
                  className="text-[#069494] hover:text-[#0EC7C7] font-medium text-sm transition-colors"
                >
                  {option.contact}
                </a>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-[#069494]/10 to-[#176161]/10 border border-[#069494]/20">
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-[#069494] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="space-y-3">
                  {quickLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className="flex items-center justify-between p-4 rounded-xl bg-[var(--card)] border border-[var(--border)] hover:border-[#069494]/30 transition-colors group"
                    >
                      <div>
                        <p className="font-medium group-hover:text-[#069494] transition-colors">{link.title}</p>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-[var(--card)] border border-[var(--border)] flex items-center justify-center hover:border-[#069494]/30 hover:text-[#069494] transition-colors"
                  >
