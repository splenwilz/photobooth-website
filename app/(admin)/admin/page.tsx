        ...
        <div className="p-5 rounded-2xl bg-white dark:bg-[#111111] border border-[var(--border)] space-y-4">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-[var(--border)]">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="/admin/booths" className="text-sm text-[#0891B2] hover:text-[#22D3EE]">View →</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/admin/booths" className="text-sm text-[#0891B2] hover:text-[#22D3EE] transition-colors">
              View All →
            </a>
          </div>
